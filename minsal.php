...
$sql    = 'SELECT MIN(sal) AS minsal,name as nam FROM profession_details pr,personal_details pe where pr.aadhaar_number=pe.aadhaar_number;';
$query  = mysqli_query($connection,$sql);
$result = mysqli_fetch_assoc($query);
echo"MINIMUM SALARY AMONG ALL: Rs ";
print($result['minsal']);
echo"<br>";
echo"PERSON WITH MINIMUM SALARY : ";
print($result['nam']);
