...
<body style="background-image: url(modify.jfif);background-repeat: no-repeat;background-size: cover;margin-top: 10%;">
	<div style="margin-top: 10%;text-align: center;">	<form method="post" >
		<input type="text" name="oa" placeholder="Enter new office address">
...
$ano=$_SESSION['adh'];
$e=$_POST['oa'];
$sql = "UPDATE profession_details SET addr='$e' WHERE aadhaar_number='$ano'";
