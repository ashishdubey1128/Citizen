...
<body>
	...
	<div class="container">
		...
		<form method="post" action="">
			...
			<input type="submit" name="submit" value="OK" class="btn btn-primary btn large" style="margin-left: 45%;margin-top: 50px;width: 100px;margin-bottom: 20px">
		</form>
	</div>
...
{ 
	$query1 = ("CREATE TABLE bank_details(pan_no varchar(30) NOT NULL,aadhaar_number varchar(30),bank_name varchar(20),acc_no varchar(10),nom_name varchar(10))");
